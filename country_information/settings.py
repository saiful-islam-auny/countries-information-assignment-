"""
Django settings for country_information project.
...
SECRET_KEY = 'django-insecure-n!k1)r@$b^b827^v)o(n5!q47_39gxg5g(zt1q^7b9tztckr4p'
...
ROOT_URLCONF = 'country_information.urls'
...
LOGIN_REDIRECT_URL = '/countries/'  # After login, redirect to the country list page
